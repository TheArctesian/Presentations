/**
 * Image dithering utility using Floyd-Steinberg algorithm with Nord color palette
 * Following Single Responsibility Principle - handles image dithering only
 */

// Nord color palette for dithering
const NORD_PALETTE: [number, number, number][] = [
	// Polar Night
	[46, 52, 64], // nord0
	[59, 66, 82], // nord1
	[67, 76, 94], // nord2
...
/**
 * Find the closest Nord color to the given RGB values
 */
...
/**
 * Apply Floyd-Steinberg dithering to an image using Nord color palette
 * @param imageData - The image data to dither
 * @param noiseAmount - Amount of noise to add before quantization (0-1), default 0.1
